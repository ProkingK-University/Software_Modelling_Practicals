...
void testingOpenGLFactory()
{
    ...
    primitiveObjectSquare.setYCord(1);
    ...
    primitiveObjectRectangle.setYCord(2);
    ...
    primitiveObjectTriangle.setXCord(3);
    primitiveObjectTriangle.setYCord(6);
...
void testingVulkanFactory()
{
    ...
    VulkanPrimitive primitiveObjectSquare = *(VulkanPrimitive*) vulkanFactory->createPrimitive();
    primitiveObjectSquare.setShape("Square");
    ...
    VulkanPrimitive primitiveObjectRectangle = *(VulkanPrimitive*) vulkanFactory->createPrimitive();
    primitiveObjectRectangle.setShape("Rectangle");
    ...
    std::cout << "======================= Creating Triangle OpenGLPrimitive Object =======================" << std::endl;
    VulkanPrimitive primitiveObjectTriangle = *(VulkanPrimitive*) vulkanFactory->createPrimitive();
    primitiveObjectTriangle.setShape("Triangle");
